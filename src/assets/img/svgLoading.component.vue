<template>
  ...
  <svg
    @ready="svgLoaded"
    cache-id="78e69f9014854d40b2600be51cad6615"
    id="eA7bMUIaCWP1"
...
onMounted(() => {
  !(function (t, e) {
      ...
      return a
        ? ((n = a),
          ...
          function (t, e) {
            ...
            var c = !1;
            if (f > a)
              (l = s), (c = !0), -1 === r.fill && (l = r.direction > 0 ? 0 : i);
    ...
    function Ft(t, e, n, r, i) {
      ...
      return (
        u ||
          (u = { x: Rt(t.x, e.x, n.x, r.x, i), y: Rt(t.y, e.y, n.y, r.y, i) }),
        o && (u.a = Ct(t, e, n, r, i)),
        u
      );
    }
    ...
    function Lt(t, e, n) {
      ...
      if (qt(e)) {
        ...
        if (zt(e))
          return Vt(n) ? Ft(e, e.end, n.start, n, t, r) : Tt(e, e.end, n, t, r);
        if (Vt(n)) return Tt(e, n.start, n, t, r);
      }
      return Pt(e, n, t, r);
    }
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    e === ve && this.trigger(t ? "end" : "pause", this.offset),
                    n
                  );
                },
              },
      ...
      animations: [
        {
          ...
          s: "|",
        },
      ],
      options:
        "MDVAxODkyMzk4YBThiNzg4OVU4TYjM5NTEzOTgF3ODk4NjdlODYk3ODg0ODQ3OWDhiODA3YTM5COTQ/",
    },
    "__SVGATOR_PLAYER__",
    window
  );
